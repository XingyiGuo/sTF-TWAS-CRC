...
tmp=colnames(y_sim)[9:length(colnames(y_sim))][101:1000]
sim_num = sub("^X", "", tmp)
...
fwrite(as.data.frame(glm_res), paste0(wk, "/simulation_values_res/lmer_res/TFs_",snps,"_SNPs_100-1000y_null.lmer.csv"))
